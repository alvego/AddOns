...
------------------------------------------------------------------------------------------------------------------
function TryBuffs()
    if not (HasMyBuff("Командирский крик") or HasBuff("Боевой крик") or HasBuff("благословение могущества")) and UnitMana("player") > 10 and DoSpell("Боевой крик") then return end
